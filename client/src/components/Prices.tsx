...
const PriceItem: React.FC<{ service: string; price: string }> = ({ service, price }) => (
  <div className="flex justify-between items-center border-b border-[#52575D] pb-3">
    <span className="font-body text-[#F6F4E6]">{service}</span>
    <span className="font-heading font-semibold text-[#FDDB3A]">{price}</span>
  </div>
);
...
const Prices: React.FC = () => {
  ...
  return (
    <section id="prices" ref={sectionRef} className="py-16 md:py-24 bg-[#52575D]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="font-bold text-3xl md:text-4xl text-[#F6F4E6] mb-4 fade-in" style={{ fontFamily: 'Playfair Display, serif' }}>Price List</h2>
          <p className="font-body text-[#F6F4E6] max-w-2xl mx-auto fade-in stagger-delay-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          {/* Shoe Repair - Large */}
          <div className="bg-[#41444B] rounded-lg shadow-md p-6 scale-in">
            <h3 className="font-heading font-semibold text-2xl text-[#F6F4E6] mb-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Shoe Repair - Small */}
          <div className="bg-[#41444B] rounded-lg shadow-md p-6 scale-in stagger-delay-1">
            <h3 className="font-heading font-semibold text-2xl text-[#F6F4E6] mb-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          {/* Shoe Repair - Other */}
          <div className="bg-[#41444B] rounded-lg shadow-md p-6 scale-in stagger-delay-2">
            <h3 className="font-heading font-semibold text-2xl text-[#F6F4E6] mb-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Watch Repair */}
          <div className="bg-[#41444B] rounded-lg shadow-md p-6 scale-in stagger-delay-3">
            <h3 className="font-heading font-semibold text-2xl text-[#F6F4E6] mb-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          {/* Jewelry Repair */}
          <div className="bg-[#41444B] rounded-lg shadow-md p-6 scale-in stagger-delay-4">
            <h3 className="font-heading font-semibold text-2xl text-[#F6F4E6] mb-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* Free Estimates */}
          <div className="bg-[#41444B] rounded-lg shadow-md p-6 scale-in stagger-delay-5">
            <h3 className="font-heading font-semibold text-2xl text-[#F6F4E6] mb-6 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="font-body text-[#F6F4E6] mb-6">
            ...
            <div className="bg-[#52575D] rounded-lg p-6 shadow-sm">
              <h4 className="font-heading font-semibold text-xl text-[#FDDB3A] mb-3">Our Promise</h4>
              <p className="font-body text-[#F6F4E6] mb-4">
              ...
              <a 
                href="#contact" 
                className="inline-block bg-[#FDDB3A] text-[#41444B] font-heading font-semibold px-6 py-2 rounded hover:bg-opacity-90 transition-colors"
              >
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-[#F6F4E6] italic">
