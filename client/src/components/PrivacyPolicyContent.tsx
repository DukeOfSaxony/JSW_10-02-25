  ...
  return (
    <div className="min-h-screen bg-black text-gray-200 pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="mb-6">
          At Josephs's Shoe & Watch Repair, your privacy is important to us. We're committed to protecting any personal information you provide, whether you're booking a repair, sending a message, or simply browsing our site.
        </p>

        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">1. Information We Collect</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">2. How We Use Your Information</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">3. Data Storage</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">4. Cookies & Tracking</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">5. Your Rights</h2>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">6. Contact</h2>
