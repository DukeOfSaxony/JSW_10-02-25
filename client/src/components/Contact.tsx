...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-16 md:py-24 bg-[#F6F4E6]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 fade-in stagger-delay-2">
            <h3 className="font-heading font-semibold text-2xl text-[#41444B] mb-6">Send Us a Message</h3>
            ...
            >
              ...
              <div className="form-input">
                <label htmlFor="name" className="block font-body text-[#52575D] mb-2">Your Name</label>
                <input 
                  type="text" 
                  id="name" 
                  name="name" 
                  required 
                  className="focus:ring-[#FDDB3A]"
                  value={formData.name}
              ...
              <div className="form-input">
                <label htmlFor="email" className="block font-body text-[#52575D] mb-2">Email Address</label>
                <input 
                  type="email" 
                  id="email" 
                  name="email" 
              ...
              <div className="form-input">
                <label htmlFor="phone" className="block font-body text-[#52575D] mb-2">Phone Number</label>
                <input 
                  type="tel" 
                  id="phone" 
                  name="phone" 
              ...
              <div className="form-input">
                <label htmlFor="service" className="block font-body text-[#52575D] mb-2">Service Needed</label>
                <select 
                  id="service" 
                  name="service" 
                  required
                  className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#FDDB3A] focus:border-[#FDDB3A] bg-white"
              ...
              <div className="form-input">
                <label htmlFor="message" className="block font-body text-[#52575D] mb-2">Your Message</label>
                <textarea 
                  id="message" 
                  name="message" 
                  rows={4} 
              ...
              <div className="form-input">
                <label htmlFor="image" className="block font-body text-[#52575D] mb-2">Upload Image (Optional)</label>
                <input 
                  type="file" 
                  id="image" 
                  name="image" 
              ...
              <button 
                ...
                className={`w-full bg-[#FDDB3A] text-[#41444B] font-heading font-semibold py-3 px-6 rounded hover:bg-opacity-90 transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'pulse-animation'}`}
              >
          ...
          <div className="fade-in stagger-delay-3">
            <div className="bg-[#41444B] text-white rounded-lg shadow-md p-8 mb-8">
              <h3 className="font-heading font-semibold text-2xl mb-6">Our Information</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mt-1 mr-4 text-[#FDDB3A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-heading font-semibold text-lg mb-2">Business Hours</h4>
                    <table className="font-body text-gray-300">
                      <tbody>
                        <tr>
            ...
            <div className="rounded-lg shadow-md overflow-hidden h-64 fade-in stagger-delay-4">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3025.4869476766724!2d-73.99349!3d40.6863311!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a565b64b3bb%3A0x3c6c3a3f5b2b4b4a!2s178%20Smith%20St%2C%20Brooklyn%2C%20NY%2011201!5e0!3m2!1sen!2sus!4v1234567890!5m2!1sen!2sus" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                allowFullScreen 
                ...
                title="Shoe & Watch Repair Location"
              ></iframe>
            </div>
          </div>
        </div>
