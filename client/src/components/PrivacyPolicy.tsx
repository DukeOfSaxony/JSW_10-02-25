...
import michaelsLogo from '@assets/green_logo_1759348887630.png';
    ...
    <div className="min-h-screen bg-black text-gray-200 pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-3xl">
        <button 
          ...
          className="mb-8 flex items-center text-[#FDDB3A] hover:text-white transition-colors"
        >
        ...
        <p className="mb-6">
          Welcome to Josephs's Shoe & Watch Repair. By using our services, you agree to the following terms. Please read them carefully.
        </p>

        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">1. Services Offered</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">2. Estimates & Approvals</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">3. Payment Terms</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">4. Turnaround Time</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">5. Shipping & Handling</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">6. Risk of Loss</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">7. Unclaimed Items</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">8. Warranty & Limitations</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">9. Limitation of Liability</h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">10. Modifications to Terms</h2>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-3 text-[#FDDB3A]">11. Contact Information</h2>
          <p>If you have questions or concerns about these terms, please contact us:</p>
          <p className="mt-2 font-bold text-white">Josephs's Shoe & Watch Repair</p>
          <p>178 Smith St, Brooklyn, NY 11201</p>
          <p>(718) 522-5243</p>
          <p>jdavydov@gmail.com</p>
        </div>

        <button 
          onClick={handleBackClick}
          className="mb-12 px-6 py-3 bg-[#FDDB3A] hover:bg-opacity-90 transition-colors text-white rounded-md"
        >
          Back to Main Site
        </button>
      </div>
